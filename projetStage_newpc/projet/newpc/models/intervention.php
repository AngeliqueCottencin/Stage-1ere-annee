...
function inter_add($cli, $creation, $probleme, $notes, $solution, $facturation) {
	global $pdo;
	$req = "INSERT INTO intervention(id_client, creation, probleme, notes_travail, solution, facturation) VALUES (:cli, :creation, :probleme, :notes, :solution, :facturation);";
	$query = $pdo->prepare ( $req );
	$query->bindValue ( ":cli", $cli, PDO::PARAM_INT );
